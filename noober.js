...
let color
  ...
  if (ride.length ==1 ){
    ...
    <div class="border-4 border-${color}-500 p-4 my-4 text-left">
      <div class="flex">
        <div class="w-1/2">
        ...
        <div class="w-1/2 text-right">
          <span class="rounded-xl bg-${color}-600 text-white p-2">
...
<div class="border-4 border-${color}-900 p-4 my-4 text-left">
  <div class="flex">
    <div class="w-1/2">
      <h2 class="text-2xl py-1">${ride[0].passengerDetails.first} ${ride[0].passengerDetails.last}</h2>
      <p class="font-bold text-gray-600">${ride[0].passengerDetails.phoneNumber}</p>
